 ...
 public:
  ...
  void emitPrologue(int maxLocals) override {
    ...
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    JIT_FIRST_ARG_SLOT * sizeof(double), SLJIT_FR0, 0);
  }
  ...
  void emitLoadConst(int stackOffset, double value) override {
    ...
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    stackOffset * sizeof(double), SLJIT_FR0, 0);
  }

  void emitGetLocal(int stackOffset, int localSlot) override {
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    stackOffset * sizeof(double), SLJIT_MEM1(SLJIT_S1),
                    localSlot * sizeof(double));
  }

  void emitSetLocal(int localSlot, int stackOffset) override {
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    localSlot * sizeof(double), SLJIT_MEM1(SLJIT_S1),
  ...
  void emitMove(int targetOffset, int srcOffset) override {
    if (srcOffset == -1) {
      ...
      sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                      targetOffset * sizeof(double), SLJIT_MEM1(SLJIT_S1),
  ...
  void emitSetLocalFromFR0(int localSlot) {
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    localSlot * sizeof(double), SLJIT_FR0, 0);
  }

  void emitAddMemToFR0(int memStackOffset) {
    sljit_emit_fop2(compiler, SLJIT_ADD_F64, SLJIT_FR0, 0, SLJIT_MEM1(SLJIT_S1),
                    memStackOffset * sizeof(double), SLJIT_FR0, 0);
  }

  void emitSubMemToFR0(int memStackOffset) {
    // FR0 = mem - FR0
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR1, 0, SLJIT_MEM1(SLJIT_S1),
                    memStackOffset * sizeof(double));
    sljit_emit_fop2(compiler, SLJIT_SUB_F64, SLJIT_FR0, 0, SLJIT_FR1, 0,
                    SLJIT_FR0, 0);
  }

  void emitMulMemToFR0(int memStackOffset) {
    sljit_emit_fop2(compiler, SLJIT_MUL_F64, SLJIT_FR0, 0, SLJIT_MEM1(SLJIT_S1),
                    memStackOffset * sizeof(double), SLJIT_FR0, 0);
  }
  ...
  void emitDivMemToFR0(int memStackOffset) {
    ...
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR1, 0, SLJIT_MEM1(SLJIT_S1),
                    memStackOffset * sizeof(double));
    sljit_emit_fop2(compiler, SLJIT_DIV_F64, SLJIT_FR0, 0, SLJIT_FR1, 0,
                    SLJIT_FR0, 0);
  }
  ...
  void emitCmpLtJumpIfFalse(int targetOffset, int srcOffset,
                            size_t targetByteCodeIndex) {
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR1, 0, SLJIT_MEM1(SLJIT_S1),
  ...
  void emitCmpLeJumpIfFalse(int targetOffset, int srcOffset,
                            size_t targetByteCodeIndex) {
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR1, 0, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double));
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR2, 0, SLJIT_MEM1(SLJIT_S1),
  ...
  void emitCmpGtJumpIfFalse(int targetOffset, int srcOffset,
                            size_t targetByteCodeIndex) {
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR1, 0, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double));
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR2, 0, SLJIT_MEM1(SLJIT_S1),
  ...
  void emitCmpGeJumpIfFalse(int targetOffset, int srcOffset,
                            size_t targetByteCodeIndex) {
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR1, 0, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double));
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR2, 0, SLJIT_MEM1(SLJIT_S1),
  ...
  void emitCmpEqJumpIfFalse(int targetOffset, int srcOffset,
                            size_t targetByteCodeIndex) {
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR1, 0, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double));
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR2, 0, SLJIT_MEM1(SLJIT_S1),
  ...
  void emitCmpNeJumpIfFalse(int targetOffset, int srcOffset,
                            size_t targetByteCodeIndex) {
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR1, 0, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double));
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR2, 0, SLJIT_MEM1(SLJIT_S1),
  ...
  void emitAddConst(int targetOffset, double value) {
    ...
    sljit_emit_fop2(compiler, SLJIT_ADD_F64, SLJIT_FR1, 0, SLJIT_FR1, 0,
                    SLJIT_FR2, 0);
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double), SLJIT_FR1, 0);
  }
  ...
  void emitSubConst(int targetOffset, double value) {
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR1, 0, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double));
    sljit_emit_fset64(compiler, SLJIT_FR2, value);
    sljit_emit_fop2(compiler, SLJIT_SUB_F64, SLJIT_FR1, 0, SLJIT_FR1, 0,
                    SLJIT_FR2, 0);
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double), SLJIT_FR1, 0);
  }

  void emitCmpLtConstJumpIfFalse(int targetOffset, double value,
                                 size_t targetByteCodeIndex) {
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR1, 0, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double));
    sljit_emit_fset64(compiler, SLJIT_FR2, value);
  ...
  void emitCmpLeConstJumpIfFalse(int targetOffset, double value,
                                 size_t targetByteCodeIndex) {
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR1, 0, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double));
    sljit_emit_fset64(compiler, SLJIT_FR2, value);
  ...
  void emitMul(int targetOffset, int srcOffset) override {
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR1, 0, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double));
    sljit_emit_fop2(compiler, SLJIT_MUL_F64, SLJIT_FR1, 0, SLJIT_FR1, 0,
                    SLJIT_MEM1(SLJIT_S1), srcOffset * sizeof(double));
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double), SLJIT_FR1, 0);
  }
  ...
  void emitDiv(int targetOffset, int srcOffset) override {
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR1, 0, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double));
    sljit_emit_fop2(compiler, SLJIT_DIV_F64, SLJIT_FR1, 0, SLJIT_FR1, 0,
                    SLJIT_MEM1(SLJIT_S1), srcOffset * sizeof(double));
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double), SLJIT_FR1, 0);
  }
  ...
  void emitMod(int targetOffset, int srcOffset) override {
    ...
    sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS2(F64, F64, F64),
                     SLJIT_IMM, (sljit_sw)jit_mod_helper);
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double), SLJIT_FR0, 0);
  }

  void emitBitAnd(int targetOffset, int srcOffset) override {
    sljit_emit_fop1(compiler, SLJIT_CONV_SW_FROM_F64, SLJIT_R0, 0,
                    SLJIT_MEM1(SLJIT_S1), targetOffset * sizeof(double));
    sljit_emit_fop1(compiler, SLJIT_CONV_SW_FROM_F64, SLJIT_R1, 0,
                    SLJIT_MEM1(SLJIT_S1), srcOffset * sizeof(double));
    sljit_emit_op2(compiler, SLJIT_AND, SLJIT_R0, 0, SLJIT_R0, 0, SLJIT_R1, 0);
    sljit_emit_fop1(compiler, SLJIT_CONV_F64_FROM_SW, SLJIT_FR1, 0, SLJIT_R0,
                    0);
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double), SLJIT_FR1, 0);
  }
  ...
  void emitBitNot(int targetOffset) override {
    sljit_emit_fop1(compiler, SLJIT_CONV_SW_FROM_F64, SLJIT_R0, 0,
                    SLJIT_MEM1(SLJIT_S1), targetOffset * sizeof(double));
    sljit_emit_op2(compiler, SLJIT_XOR, SLJIT_R0, 0, SLJIT_R0, 0, SLJIT_IMM,
                   -1);
    sljit_emit_fop1(compiler, SLJIT_CONV_F64_FROM_SW, SLJIT_FR1, 0, SLJIT_R0,
                    0);
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
  ...
  void emitNegate(int targetOffset) override {
    sljit_emit_fop1(compiler, SLJIT_NEG_F64, SLJIT_FR1, 0, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double));
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double), SLJIT_FR1, 0);
  }

  void emitCallDynamic(int targetOffset, int calleeOffset,
                       int argCount) override {
    sljit_emit_op1(compiler, SLJIT_MOV, SLJIT_R0, 0, SLJIT_S0, 0);
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR0, 0, SLJIT_MEM1(SLJIT_S1),
                    calleeOffset * sizeof(double));
    ...
    sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS4(F64, W, F64, P, W),
                     SLJIT_IMM, (sljit_sw)jit_call_helper);
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double), SLJIT_FR0, 0);
  }
  ...
  void emitGetGlobal(const std::string& name, int targetOffset) override {
    ...
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR0, 0, SLJIT_MEM1(SLJIT_R0),
                    0);
  ...
  void emitSetGlobal(const std::string& name, int sourceOffset) override {
    ...
    sljit_emit_op1(compiler, SLJIT_MOV, SLJIT_R1, 0, SLJIT_IMM,
                   (sljit_sw)cname);
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR0, 0, SLJIT_MEM1(SLJIT_S1),
                    sourceOffset * sizeof(double));
    sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS3V(W, W, F64), SLJIT_IMM,
                     (sljit_sw)jit_set_global_helper);
  }

  void emitIndexGet(int targetOffset, int objectOffset,
                    int indexOffset) override {
    sljit_emit_op1(compiler, SLJIT_MOV, SLJIT_R0, 0, SLJIT_S0, 0);
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR0, 0, SLJIT_MEM1(SLJIT_S1),
                    objectOffset * sizeof(double));
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR1, 0, SLJIT_MEM1(SLJIT_S1),
                    indexOffset * sizeof(double));
    sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS3(F64, W, F64, F64),
                     SLJIT_IMM, (sljit_sw)jit_index_get_helper);
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double), SLJIT_FR0, 0);
  }

  void emitIndexSet(int objectOffset, int indexOffset,
    ...
    sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS4(F64, W, F64, F64, F64),
                     SLJIT_IMM, (sljit_sw)jit_index_set_helper);
  }

  void emitBuildList(int targetOffset, int count) override {
    sljit_emit_op2(compiler, SLJIT_ADD, SLJIT_R0, 0, SLJIT_S1, 0, SLJIT_IMM,
                   targetOffset * sizeof(double));
    sljit_emit_op1(compiler, SLJIT_MOV, SLJIT_R1, 0, SLJIT_IMM, count);
    sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS2(F64, P, W), SLJIT_IMM,
                     (sljit_sw)jit_build_list_helper);
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double), SLJIT_FR0, 0);
  }
  ...
  void emitPropertyGet(int objectOffset, const std::string& name) override {
    ...
    sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS3(F64, W, F64, W),
                     SLJIT_IMM, (sljit_sw)jit_property_get_helper);
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
  ...
  void emitPropertySet(int objectOffset, const std::string& name) override {
    ...
    sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS4(F64, W, F64, W, F64),
                     SLJIT_IMM, (sljit_sw)jit_property_set_helper);
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    objectOffset * sizeof(double), SLJIT_FR0, 0);
  }
  ...
  void emitIterHasNext(int targetOffset) override {
    ...
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR1, 0, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double));
    sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS2(F64, F64, F64),
                     SLJIT_IMM, (sljit_sw)jit_iter_has_next_helper);
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double), SLJIT_FR0, 0);
  }
  ...
  void emitCreateClass(int targetOffset, const std::string& name) override {
    ...
    sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS2(F64, W, W), SLJIT_IMM,
                     (sljit_sw)jit_create_class_helper);
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double), SLJIT_FR0, 0);
  }
  ...
  void emitBindMethod(int targetOffset, const std::string& name,
    ...
    sljit_emit_op1(compiler, SLJIT_MOV, SLJIT_R1, 0, SLJIT_IMM,
                   isAbstract ? 1 : 0);
    sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS4(F64, F64, F64, W, W),
                     SLJIT_IMM, (sljit_sw)jit_bind_method_helper);
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double), SLJIT_FR0, 0);
  }
  ...
  void emitBindStaticMethod(int targetOffset,
    ...
    sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS3(F64, F64, F64, W),
                     SLJIT_IMM, (sljit_sw)jit_bind_static_method_helper);
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double), SLJIT_FR0, 0);
  }
  ...
  void emitInherit(int targetOffset) override {
    ...
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR1, 0, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double));
    sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS2V(F64, F64), SLJIT_IMM,
                     (sljit_sw)jit_inherit_helper);
  }
  ...
  void emitGetSuper(int targetOffset, const std::string& name) override {
    ...
    sljit_emit_op1(compiler, SLJIT_MOV, SLJIT_R0, 0, SLJIT_IMM,
                   (sljit_sw)cacheString(name));
    sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS3(F64, F64, F64, W),
                     SLJIT_IMM, (sljit_sw)jit_get_super_helper);
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double), SLJIT_FR0, 0);
  }
  ...
  void emitFieldModifier(int targetOffset, const std::string& name,
    ...
    sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS3V(F64, W, W), SLJIT_IMM,
                     (sljit_sw)jit_field_modifier_helper);
  }
  ...
  void emitCreateClosure(int targetOffset, double funcRaw,
    ...
    for (int j = 0; j < upvalueCount; j++) {
      ...
      sljit_emit_fop1(compiler, SLJIT_CONV_F64_FROM_SW, SLJIT_FR1, 0, SLJIT_R0,
                      0);
      sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                      (dataOffset + j * 2) * sizeof(double), SLJIT_FR1, 0);
      if (isLocal) {
        sljit_emit_op2(compiler, SLJIT_ADD, SLJIT_R0, 0, SLJIT_S1, 0, SLJIT_IMM,
                       index * sizeof(double));
        sljit_emit_op1(compiler, SLJIT_MOV, SLJIT_MEM1(SLJIT_S1),
                       (dataOffset + j * 2 + 1) * sizeof(double), SLJIT_R0, 0);
      }
    }
    sljit_emit_op1(compiler, SLJIT_MOV, SLJIT_R0, 0, SLJIT_S0, 0);
    ...
    sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS4(F64, W, F64, P, W),
                     SLJIT_IMM, (sljit_sw)jit_create_closure_helper);
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double), SLJIT_FR0, 0);
  }
  ...
  void emitGetUpvalue(int targetOffset, int slot) override {
    ...
    sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS2(F64, W, W), SLJIT_IMM,
                     (sljit_sw)jit_get_upvalue_helper);
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_MEM1(SLJIT_S1),
                    targetOffset * sizeof(double), SLJIT_FR0, 0);
  }
  ...
  void emitSetUpvalue(int slot, int sourceOffset) override {
    ...
    sljit_emit_fop1(compiler, SLJIT_MOV_F64, SLJIT_FR0, 0, SLJIT_MEM1(SLJIT_S1),
                    sourceOffset * sizeof(double));
    sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS3V(W, W, F64), SLJIT_IMM,
                     (sljit_sw)jit_set_upvalue_helper);
  }
  ...
  void emitCloseUpvalue(int stackOffset) override {
    ...
    sljit_emit_op2(compiler, SLJIT_ADD, SLJIT_R1, 0, SLJIT_S1, 0, SLJIT_IMM,
                   stackOffset * sizeof(double));
    sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS2V(W, P), SLJIT_IMM,
                     (sljit_sw)jit_close_upvalue_helper);
  }
