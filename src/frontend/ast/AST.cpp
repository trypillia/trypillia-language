...
void GetExpr::accept(ASTVisitor* visitor) { visitor->visit(this); }
...
void IndexGetExpr::accept(ASTVisitor* visitor) { visitor->visit(this); }

void IndexSetExpr::accept(ASTVisitor* visitor) { visitor->visit(this); }
...
void CompoundAssignExpr::accept(ASTVisitor* visitor) { visitor->visit(this); }
...
void VarStmt::accept(ASTVisitor* visitor) { visitor->visit(this); }
...
void FieldDeclNode::accept(ASTVisitor* visitor) { visitor->visit(this); }

void ClassNode::accept(ASTVisitor* visitor) { visitor->visit(this); }

void InterfaceNode::accept(ASTVisitor* visitor) { visitor->visit(this); }

void TraitNode::accept(ASTVisitor* visitor) { visitor->visit(this); }

void StaticGetExpr::accept(ASTVisitor* visitor) { visitor->visit(this); }

void StaticCallExpr::accept(ASTVisitor* visitor) { visitor->visit(this); }

void StaticSetExpr::accept(ASTVisitor* visitor) { visitor->visit(this); }

void LoadStmt::accept(ASTVisitor* visitor) { visitor->visit(this); }
...
void NamespaceStmt::accept(ASTVisitor* visitor) { visitor->visit(this); }
