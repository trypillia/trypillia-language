...
private:
  ...
  FieldDeclNode *
  parseFieldDecl(AccessModifier accessModifier = AccessModifier::PUBLIC);
  FunctionNode *
  parseFunction(AccessModifier accessModifier = AccessModifier::PUBLIC,
                bool isAbstract = false, bool isStatic = false);
