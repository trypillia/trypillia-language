...
Parser::ParseRule Parser::getRule(TokenType type) {
    switch (type) {
        case TokenType::LPAREN:       return { &Parser::parseGrouping,   &Parser::parseCall,       PREC_CALL };
        case TokenType::RPAREN:       return { nullptr,                  nullptr,                  PREC_NONE };
        case TokenType::LBRACE:       return { &Parser::parseDict,       nullptr,                  PREC_NONE };
        case TokenType::RBRACE:       return { nullptr,                  nullptr,                  PREC_NONE };
        case TokenType::LBRACKET:     return { &Parser::parseList,       &Parser::parseIndex,      PREC_CALL };
        case TokenType::RBRACKET:     return { nullptr,                  nullptr,                  PREC_NONE };
        case TokenType::COMMA:        return { nullptr,                  nullptr,                  PREC_NONE };
        case TokenType::DOT:          return { nullptr,                  &Parser::parseDot,        PREC_CALL };
        case TokenType::MINUS:        return { &Parser::parseUnary,      &Parser::parseBinary,     PREC_TERM };
        case TokenType::PLUS:         return { nullptr,                  &Parser::parseBinary,     PREC_TERM };
        case TokenType::SEMICOLON:    return { nullptr,                  nullptr,                  PREC_NONE };
        case TokenType::SLASH:        return { nullptr,                  &Parser::parseBinary,     PREC_FACTOR };
        case TokenType::STAR:         return { nullptr,                  &Parser::parseBinary,     PREC_FACTOR };
        case TokenType::PERCENT:      return { nullptr,                  &Parser::parseBinary,     PREC_FACTOR };
        case TokenType::BANG:         return { &Parser::parseUnary,      nullptr,                  PREC_NONE };
        case TokenType::BANG_EQUAL:   return { nullptr,                  &Parser::parseBinary,     PREC_EQUALITY };
        case TokenType::ASSIGN:       return { nullptr,                  &Parser::parseAssignment, PREC_ASSIGNMENT };
        case TokenType::EQUAL_EQUAL:  return { nullptr,                  &Parser::parseBinary,     PREC_EQUALITY };
        case TokenType::GREATER:      return { nullptr,                  &Parser::parseBinary,     PREC_COMPARISON };
        case TokenType::GREATER_EQUAL:return { nullptr,                  &Parser::parseBinary,     PREC_COMPARISON };
        case TokenType::LESS:         return { nullptr,                  &Parser::parseBinary,     PREC_COMPARISON };
        case TokenType::LESS_EQUAL:   return { nullptr,                  &Parser::parseBinary,     PREC_COMPARISON };
        case TokenType::IDENTIFIER:   return { &Parser::parseIdentifier, nullptr,                  PREC_NONE };
        case TokenType::STRING:       return { &Parser::parseString,     nullptr,                  PREC_NONE };
        case TokenType::NUMBER:       return { &Parser::parseNumber,     nullptr,                  PREC_NONE };
        case TokenType::AND:          return { nullptr,                  &Parser::parseBinary,     PREC_AND };
        case TokenType::CLASS:        return { nullptr,                  nullptr,                  PREC_NONE };
        case TokenType::ELSE:         return { nullptr,                  nullptr,                  PREC_NONE };
        case TokenType::FALSE:        return { &Parser::parseLiteral,    nullptr,                  PREC_NONE };
        case TokenType::FOR:          return { nullptr,                  nullptr,                  PREC_NONE };
        case TokenType::FN:           return { &Parser::parseFn,         nullptr,                  PREC_NONE };
        case TokenType::IF:           return { nullptr,                  nullptr,                  PREC_NONE };
        case TokenType::NIL:          return { &Parser::parseLiteral,    nullptr,                  PREC_NONE };
        case TokenType::OR:           return { nullptr,                  &Parser::parseBinary,     PREC_OR };
        case TokenType::RETURN:       return { nullptr,                  nullptr,                  PREC_NONE };
        case TokenType::SUPER:        return { &Parser::parseSuper,      nullptr,                  PREC_NONE };
        case TokenType::THIS:         return { &Parser::parseThis,       nullptr,                  PREC_NONE };
        case TokenType::TRUE:         return { &Parser::parseLiteral,    nullptr,                  PREC_NONE };
        case TokenType::LET:          return { nullptr,                  nullptr,                  PREC_NONE };
        case TokenType::WHILE:        return { nullptr,                  nullptr,                  PREC_NONE };
        case TokenType::END_OF_FILE:  return { nullptr,                  nullptr,                  PREC_NONE };
        case TokenType::PLUS_PLUS:    return { &Parser::parseUnary,      &Parser::parsePostfix,    PREC_CALL };
        case TokenType::MINUS_MINUS:  return { &Parser::parseUnary,      &Parser::parsePostfix,    PREC_CALL };
        case TokenType::PLUS_EQUAL:   return { nullptr,                  &Parser::parseAssignment, PREC_ASSIGNMENT };
        case TokenType::MINUS_EQUAL:  return { nullptr,                  &Parser::parseAssignment, PREC_ASSIGNMENT };
        case TokenType::STAR_EQUAL:   return { nullptr,                  &Parser::parseAssignment, PREC_ASSIGNMENT };
        case TokenType::SLASH_EQUAL:  return { nullptr,                  &Parser::parseAssignment, PREC_ASSIGNMENT };
        case TokenType::BITWISE_NOT:  return { &Parser::parseUnary,      nullptr,                  PREC_NONE };
        case TokenType::BITWISE_AND:  return { nullptr,                  &Parser::parseBinary,     PREC_BITWISE_AND };
        case TokenType::BITWISE_OR:   return { nullptr,                  &Parser::parseBinary,     PREC_BITWISE_OR };
        case TokenType::BITWISE_XOR:  return { nullptr,                  &Parser::parseBinary,     PREC_BITWISE_XOR };
        case TokenType::SHIFT_LEFT:   return { nullptr,                  &Parser::parseBinary,     PREC_SHIFT };
        case TokenType::SHIFT_RIGHT:  return { nullptr,                  &Parser::parseBinary,     PREC_SHIFT };
        case TokenType::QUESTION:     return { nullptr,                  &Parser::parseTernary,    PREC_TERNARY };
        case TokenType::COLON_COLON:  return { nullptr,                  &Parser::parseStatic,     PREC_CALL };
        default:                      return { nullptr,                  nullptr,                  PREC_NONE };
    }
}
...
ExprNode *Parser::parsePrecedence(Precedence precedence) {
    ...
    if (prefixRule == nullptr) {
        throw std::runtime_error("Expect expression at '" + previousToken.lexeme + "' line " + std::to_string(previousToken.line));
    }
...
ExprNode *Parser::parseGrouping(bool canAssign) {
    // We are at LPAREN. Could be a normal grouping (expr), or an arrow lambda (a, b) =>
...
ExprNode *Parser::parseBinary(ExprNode *left, bool canAssign) {
    ...
    // Left associative: use rule.precedence + 1. Right associative: rule.precedence
    // All our binaries (except assignment and maybe ternary) are left associative
